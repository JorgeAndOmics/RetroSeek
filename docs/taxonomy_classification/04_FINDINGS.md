...
DIAMOND optional via `--search diamond`, equivalent results, ~1.8× faster). Numbers below are
...
|---|---|---|---|---|
| Desmodus (bat) | A | Class I (gamma) | 422:274 | Class I+II, beta present (DrERV) ✓ |
| Antrozous (bat) | A | Class I (gamma) | 767:486 | Class I+II ✓ |
| Molossus (bat) | B | Class I (gamma) | 378:144 | Class I+II ✓ |
| Homo sapiens | B | Class I (gamma) | 689:186 | Class I most numerous (HERV-H/W) ✓ |
| Mus musculus | B | **Class II (beta)** | 325:442 | Class II dominant (IAP/MusD) ✓ |
