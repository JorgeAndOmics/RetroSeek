...
# visual output). Real unit tests are deferred until the karyotype builder is
# extracted into a pure function. Skipped (not fake-passing) so the coverage gap
# is honest rather than hidden behind expect_true(TRUE).
