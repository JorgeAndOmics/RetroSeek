...
# stochastic and slow) — see ROADMAP.md. Real unit tests are deferred until the
# window-tiling helper is extracted into a pure function. Skipped (not
# fake-passing) so the coverage gap is honest rather than hidden behind
# expect_true(TRUE).
